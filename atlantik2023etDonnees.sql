...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 06 fév. 2023 à 18:11
...
CREATE TABLE `enregistrer` (
  `NORESERVATION` int(2) NOT NULL,
  `LETTRECATEGORIE` char(1) NOT NULL,
  `NOTYPE` smallint(1) NOT NULL,
  `QUANTITERESERVEE` int(2) NOT NULL,
  `QUANTITEEMBARQUEE` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `liaison` (
  `NOLIAISON` int(2) NOT NULL,
  `NOPORT_DEPART` int(2) NOT NULL,
  `NOSECTEUR` int(2) NOT NULL,
  `NOPORT_ARRIVEE` int(2) NOT NULL,
...
CREATE TABLE `parametres` (
  `NOIDENTIFIANT` smallint(1) NOT NULL,
...
INSERT INTO `traversee` (`NOTRAVERSEE`, `NOLIAISON`, `NOBATEAU`, `DATEHEUREDEPART`, `DATEHEUREARRIVEE`) VALUES
(1, 1, 1, '2021-07-10 07:45:00', '2021-07-10 09:00:00'),
(2, 1, 2, '2021-07-10 09:45:00', '2021-07-10 11:00:00'),
(3, 1, 3, '2021-07-10 11:45:00', '2021-07-10 13:00:00'),
(4, 1, 4, '2021-07-10 13:45:00', '2021-07-10 15:00:00'),
(5, 1, 1, '2021-07-10 15:45:00', '2021-07-10 17:00:00'),
(6, 1, 2, '2021-07-10 17:45:00', '2021-07-10 19:00:00');
...
ALTER TABLE `liaison`
  ...
  ADD KEY `I_FK_LIAISON_PORT` (`NOPORT_DEPART`),
  ADD KEY `I_FK_LIAISON_SECTEUR` (`NOSECTEUR`),
  ADD KEY `I_FK_LIAISON_PORT1` (`NOPORT_ARRIVEE`);
...
--
ALTER TABLE `bateau`
  MODIFY `NOBATEAU` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `client`
--
ALTER TABLE `client`
  MODIFY `NOCLIENT` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `liaison`
--
ALTER TABLE `liaison`
  MODIFY `NOLIAISON` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `port`
--
ALTER TABLE `port`
  MODIFY `NOPORT` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `reservation`
--
ALTER TABLE `reservation`
  MODIFY `NORESERVATION` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `secteur`
--
ALTER TABLE `secteur`
  MODIFY `NOSECTEUR` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT pour la table `traversee`
--
ALTER TABLE `traversee`
  MODIFY `NOTRAVERSEE` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `liaison`
  ADD CONSTRAINT `FK_LIAISON_PORT` FOREIGN KEY (`NOPORT_DEPART`) REFERENCES `port` (`NOPORT`),
  ADD CONSTRAINT `FK_LIAISON_PORT1` FOREIGN KEY (`NOPORT_ARRIVEE`) REFERENCES `port` (`NOPORT`),
